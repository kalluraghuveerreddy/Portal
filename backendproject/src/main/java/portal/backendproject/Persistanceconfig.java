...
@Configuration
@ComponentScan("portal.backendproject")
...
public class Persistanceconfig {
    ...
    public DataSource getDataSource()
	{
		...
		basicDataSource.setUrl("jdbc:mysql://localhost:3306/portal");
    ...
    public   SessionFactory  localSessionFactoryBuilder()
	{
		...
		localSessionFactoryBuilder.scanPackages("portal.backendproject.model");
